...
import { DeviceTypeWithRelations } from '../model/models';
...
export class DeviceTypeControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deviceTypeControllerFind(page: number, count: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<DeviceTypeWithRelations>>;
    public deviceTypeControllerFind(page: number, count: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<DeviceTypeWithRelations>>>;
    public deviceTypeControllerFind(page: number, count: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<DeviceTypeWithRelations>>>;
    public deviceTypeControllerFind(page: number, count: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<Array<DeviceTypeWithRelations>>(`${this.configuration.basePath}/device-type/list-all/${encodeURIComponent(String(page))}/${encodeURIComponent(String(count))}`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
